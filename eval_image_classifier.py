...
checkpoint_path = '/home/raulgomez/datasets/WebVision/TF-logs-cluster/30/TF-logs/' # An absolute path to a checkpoint file
eval_dir = '/home/raulgomez/datasets/WebVision/TF-logs-cluster/30/TF-logs/' # Directory where the results are saved to
num_preprocessing_threads = 4
dataset_name = 'webvision'
dataset_split_name = 'validation'
dataset_dir = '/home/raulgomez/datasets/WebVision/TF-dataset/'
...
tf.app.flags.DEFINE_integer(
    'eval_image_size', eval_image_size, 'Eval image size')
