...
# Learning Rate Flags #
#######################
learning_rate_decay_type = 'exponential' # Specifies how the learning rate is decayed. One of "fixed", "exponential", or "polynomial"
...
tf.app.flags.DEFINE_integer('num_clones', num_clones,
...
tf.app.flags.DEFINE_float(
    'weight_decay', weight_decay, 'The weight decay on the model weights.')
...
tf.app.flags.DEFINE_float('opt_epsilon', opt_epsilon, 'Epsilon term for the optimizer.')

tf.app.flags.DEFINE_float('ftrl_learning_rate_power', ftrl_learning_rate_power,
...
tf.app.flags.DEFINE_float('rmsprop_momentum', rmsprop_momentum, 'Momentum.')

tf.app.flags.DEFINE_float('rmsprop_decay', rmsprop_decay, 'Decay term for RMSProp.')
...
tf.app.flags.DEFINE_float(
    'label_smoothing', label_smoothing, 'The amount of label smoothing.')

tf.app.flags.DEFINE_float(
    'learning_rate_decay_factor', learning_rate_decay_factor, 'Learning rate decay factor.')
...
tf.app.flags.DEFINE_string(
    'dataset_split_name', dataset_split_name, 'The name of the train/test split.')
...
tf.app.flags.DEFINE_string(
    'preprocessing_name', preprocessing_name, 'The name of the preprocessing to use. If left '
...
tf.app.flags.DEFINE_integer(
    'train_image_size', train_image_size, 'Train image size')

tf.app.flags.DEFINE_integer('max_number_of_steps', max_number_of_steps,
